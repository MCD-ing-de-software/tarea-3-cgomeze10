...
class TestStatisticsUtils(unittest.TestCase):
    ...
    def test_moving_average_raises_for_invalid_window(self):
        ...
        utils = StatisticsUtils()
        arr = [1, 2, 3]
        self.assertRaises(ValueError, utils.moving_average, arr, 0)
        self.assertRaises(ValueError, utils.moving_average, arr, 4)
    ...
    def test_zscore_has_mean_zero_and_unit_std(self):
        ...
        self.assertAlmostEqual(result_mean, 0) 
        self.assertAlmostEqual(result_std, 1)
    ...
    def test_min_max_scale_maps_to_zero_one_range(self):
        ...
        self.assertAlmostEqual(result_min, 0.0)
        self.assertAlmostEqual(result_max, 1.0)
        npt.assert_allclose(result, expected)
